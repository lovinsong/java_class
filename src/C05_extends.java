...
public class C05_extends {
	...
	// - 자식 클래스는 부모에게 없던 기능을 마음대로 추가해서 쓸수도 있다
...
//		Police police02 = new Person(); 이미 치의가 펄슨2에 등록이 되었는데 이중 직업?을 가지게 되어  겹치게 된다.
		
		// 원래 Police였던 인스턴스는 다시 Police로 다운 캐스팅 될 수 있다
		Police police = (Police)person01;
//		Police polioce2 = (Police)person02;
