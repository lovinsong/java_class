...
public class RankClassVer {
	...
	static {
		names = new String[] { "ACE", "DEUCE", "THREE", "FOUR", "FIVE", "SIX", "SEVEN", "EIGHT", "NINE", "TEN", "JACK",
				"QUEEN", "KING" };
		...
		values = new RankClassVer[] { ACE, DEUCE, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, TEN, JACK, QUEEN, KING };
	...
	// private생성자 : 외부에서는 인스턴스를 생성할 수 없게 만들기
