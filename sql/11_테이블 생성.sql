...
-- 연습문제 01: 50번 부서 사람들로만 구성된 테이블을 하나 생성해보세요
...
-- # ALTER TABLE 테이블명 ADD COLUMN (컬럼명1 컬럼타입1, 컬럼명2 컬럼타입2, ...)
...
/*
    ...
    # 데이터 딕셔너리 뷰
        - 데이터 딕셔너리를 사용자가 보기 편하도록 변환하여 제공하는 뷰(View)
*/
...
SELECT * FROM all_tables; -- ALL_ : 모든 USER가 가지고 있는 정보만 보여주는 데이터 딕셔너리 뷰
